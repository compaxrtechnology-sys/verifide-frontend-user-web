      ...
      >
        <nav className="flex-1 overflow-y-auto mt-4 pb-6 p-2 ">
          ...
          <button
            ...
            className="block  text-left px-4 py-3 text-sm glassy-text-primary hover:bg-[var(--bg-card)] transition-colors flex items-center gap-2 mx-2"
          >
          ...
          <div className="glassy-card p-2 m-2">
            ...
            <div className="flex items-center justify-between rounded-xl glassy-card p-3 hover:opacity-90 transition">
              {/* Left */}
