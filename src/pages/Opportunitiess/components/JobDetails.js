        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1">
              ...
              <p className="text-sm capitalize glassy-text-primary">
                {data?.job_type?.replace("-", " ")}
              </p>
            </div>
            <div className="space-y-1">
              <p className="text-sm font-medium glassy-text-secondary">
          ...
          <div className="glassy-card p-3 rounded-lg">
            ...
            <p className="font-medium glassy-text-primary">
              {data?.salary_range}
            </p>
          </div>
          ...
          <div>
            <h4 className="font-medium glassy-text-primary mb-2">
              Job Description
            </h4>

            <p className="text-sm glassy-text-secondary whitespace-pre-line break-words">
              {isExpandedMobile
                ? data?.job_description
                : data?.job_description.slice(0, 200)}
              {data?.job_description.length > 200 && (
                <>
                  {!isExpandedMobile && "..."}
                  <button
          ...
          <div className="grid grid-cols-2 gap-4 border-t pt-4">
            ...
            <div>
              ...
              <p className="text-sm glassy-text-primary">{data?.total_applicants || 0}</p>
            </div>
          </div>
        </div>
      </div>
