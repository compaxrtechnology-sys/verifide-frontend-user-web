...
const JobCard = ({
  ...
  // ADD THIS inside your component (after useState declarations)
  ...
  return (
    <div className="mb-3">
      <div
        className={`relative z-20 rounded-lg shadow-md p-4 glassy-card flex flex-col justify-between  cursor-pointer ${
          ...
          <div className="flex flex-col space-y-3 mt-3 w-full">
            ...
            {!job?.user_id && (
              <div className="flex flex-wrap gap-2 text-xs glassy-text-primary">
                ...
                {job?.degree_id?.name && (
                  <span className="px-3 py-1 glassy-card rounded-full capitalize">
                    Degree : {job.degree_id.name}
                  </span>
                )}

                {/* ✅ Field of Study Badge */}
                {job?.field_of_studies?.name && (
                  <span className="px-3 py-1 glassy-card rounded-full capitalize">
                    Field : {job.field_of_studies.name}
                  </span>
                )}
              </div>
            )}
            ...
            {job?.user_id ? (
              <>
                ...
                <span
                  ...
                  onClick={stopPropagation(() => onAction("view", job))}
                >
                  <MdMessage />
                </span>
              </>
              ...
              <>
                ...
                <Button
                  onClick={stopPropagation(() => onAction("edit", job))}
                  size="sm"
                  variant="outline"
                  className="min-w-20 h-8"
                >
                ...
                <Button
                  variant="outline"
                  onClick={stopPropagation(() => onAction("view_details", job))}
                  size="sm"
                  className="min-w-20 h-8"
                >
                  Details
