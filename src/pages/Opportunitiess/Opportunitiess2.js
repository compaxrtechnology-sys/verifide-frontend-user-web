...
const Opportunitiess2 = () => {
  ...
  const fetchJobs = async () => {
    ...
    if(searchFelids?.degree_id) filters.degree_id = searchFelids.degree_id;
    if(searchFelids?.field_of_studies) filters.field_of_studies = searchFelids.field_of_studies;
        ...
        <div className="space-y-5">
          ...
          >
            ...
            <FilterSelect2
              ...
              selectedOption={
                searchFelids.timePeriod
                  ? {
                      label: searchFelids.timePeriod,
                      value: searchFelids.timePeriod,
                    }
                  : null
              }
            ...
            <FilterSelect2
              ...
              selectedOption={allSkillsList?.filter((opt) =>
                searchFelids.required_skills.includes(opt.value),
              )}
              onChange={(selected) =>
            ...
            <FilterSelect2
              ...
              selectedOption={
                degreeList?.find(
                  (opt) => opt.value === searchFelids?.degree_id,
                ) || null
              }
            ...
            <FilterSelect2
              ...
              selectedOption={
                fieldsOfStudyList?.find(
                  (opt) => opt.value === searchFelids?.field_of_studies,
                ) || null
              }
              onChange={(selected) =>
              ...
              // isDisabled={!searchFelids.degree_id}
