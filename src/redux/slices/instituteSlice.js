...
import { createExtraReducersForThunk, createApiThunkPrivate, createApiThunkPublic } from '../../../src/components/hooks/apiThunk';
...
export const createInstitution = createApiThunkPublic('createInstitution', '/user/institutions/create', 'POST');
export const registerInstitution = createApiThunkPublic('registerInstitution', '/institutions/authorization/register', 'POST');
