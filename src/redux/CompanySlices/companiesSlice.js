...
const initialState = {
    getCompaniesListData: {}, getCompaniesDetailsData: {}, getListData: {}, getPostListData: {}, notificationsData: {}, getAssignedUsersData: {}, getActiveEmployeesData: {}
}
...
const companiesSlice = createSlice({
    ...
    extraReducers: builder => {
        ...
        createExtraReducersForThunk(builder, getActiveEmployees, 'getActiveEmployeesData');
